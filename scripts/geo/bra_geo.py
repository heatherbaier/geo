...
# Clean coordinates
bra_ef = pd.read_csv("/Users/heatherbaier/Documents/geo_git/data/BRA/Análise - Tabela da lista das escolas - Detalhado.csv")
...
bra_ef['geo_id'] = bra_ef['index'].apply(lambda x: 'BRA-{0:0>6}'.format(x))
bra_ef = bra_ef[["geo_id", "deped_id", "school_name", "latitude", "longitude"]]
bra_ef["address"] = None
...
bra_ef = bra_ef[["geo_id","deped_id","school_name","address","adm0","adm1","adm2","adm3","longitude","latitude"]]

bra_ef.to_csv("/Users/heatherbaier/Documents/geo_git/files_for_db/geo/bra_geo.csv", index = False)
...
if not os.path.exists("/Users/heatherbaier/Documents/geo_git/files_for_db/shps/bra/"):
    os.mkdir("/Users/heatherbaier/Documents/geo_git/files_for_db/shps/bra/")

gdf.to_file("/Users/heatherbaier/Documents/geo_git/files_for_db/shps/bra/bra.shp", index = False)

shutil.make_archive("/Users/heatherbaier/Documents/geo_git/files_for_db/shps/bra", 'zip', "/Users/heatherbaier/Documents/geo_git/files_for_db/shps/bra")